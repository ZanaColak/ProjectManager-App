import { Text, View, TextInput, TouchableOpacity, StyleSheet, Image, ImageBackground } from "react-native";  // Import Image from react-native
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <Image
                    source={require('../assets/images/novonesis.png')}
                    style={styles.logo}
                />
            ...
            <ImageBackground
                source={require('../assets/images/innovation-campus.webp')} // Ensure the image exists in the assets folder
                style={styles.backgroundImage}
                imageStyle={styles.backgroundImageStyle} // Ensure correct cropping of the image
            >
                {/* Input fields */}
                <TextInput
                    style={styles.input}
